"""
Run annual validation for 2035 upgraded_tx network (all 12 months).
"""
...
print("="*80)
print("2035 ANNUAL VALIDATION (12 MONTHS)")
print("="*80)
...
summary_file = RESULTS_DIR / 'annual_summary_2035.csv'
