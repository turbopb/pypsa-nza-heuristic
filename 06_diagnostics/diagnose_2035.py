...
Diagnostic for 2035 inadequate months.

Run from repo root:
    python diagnose_2035.py
"""
...
OUTPUT_PATH = r"C:\Users\Public\Documents\Thesis\analysis\pypsa-nza-heuristic\diagnose_2035_results.txt"
...
for month in MONTHS:
    ...
    n = load_base_network(config, year=2035, month=month)
